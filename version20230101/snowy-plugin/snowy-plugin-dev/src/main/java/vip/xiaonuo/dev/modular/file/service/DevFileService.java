...
public interface DevFileService extends IService<DevFile> {
     ...
     **/
    String uploadReturnId(String engine, MultipartFile file,String FileSource);
     ...
     * @date 2022/4/22 15:53
     **/
    String uploadReturnUrl(String engine, MultipartFile file,String FileSource);
    ...
    byte[] getImage(DevFileIdParam devFileIdParam) throws FileNotFoundException, Exception;//新增接口
    byte[] getImage(String id) throws FileNotFoundException, Exception;//新增接口
    /**
     * 获取文件详情
     *
     * @author xuyuxiang
