...
export default {
	...
	// 隐患图片件上传，返回文件Url
	fileUploadYinhuanReturnUrl(data) {
		return request('uploadYinhuanReturnUrl', data)
	},
	// 隐患排查治理计划文件上传，返回文件Url
	fileUploadPlanReturnUrl(data) {
		return request('uploadPlanReturnUrl', data)
	},
	// 隐患排查标准清单文件上传，返回文件Url
	fileUploadListReturnUrl(data) {
		return request('uploadListReturnUrl', data)
	},
	// 隐患排查工作方案文件上传，返回文件Url
	fileUploadProgrammeReturnUrl(data) {
		return request('uploadProgrammeReturnUrl', data)
	},
	// 本地文件上传，返回文件Url
	...
	// 获取文件分页列表
	filePlan(data) {
		return request('filePlan', data, 'get')
	},
	// 获取文件分页列表
	filelistpage(data) {
		return request('fileList', data, 'get')
	},
	// 获取文件分页列表
	fileProgramme(data) {
		return request('fileProgramme', data, 'get')
	},
	// 获取文件列表
	fileList(data) {
